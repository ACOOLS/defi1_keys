...
def detect_vid(yolo, video_path, output_path=''):
    
    r_video =yolo.detect_video(video_path,output_path)
    r_video.save(output_path)
    yolo.close_session()
...
if __name__ == '__main__':
    ...
    if FLAGS.image:
        ...
        detect_vid(YOLO(FLAGS.classes,FLAGS.anchors,FLAGS.model), FLAGS.input, FLAGS.output)
